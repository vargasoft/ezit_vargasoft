...
$title = "A Miskolc Ablak - Referencia munkáink";
$description = "Szolgáltatásaink minőségére és az ügyfeleink elégedettségére a legnagyobb hangsúlyt fektetjük. Tekintse meg munkáinkat és vegye igénybe szolgáltatásainkat most.";
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
											...
											<li class="active"><a href="<?php echo $server.'munkaink/';?>">Munkáink</a></li>
    ...
    <div class="site-main">
        ...
        <section class="ttm-row pt-60 pb-110 res-991-pb-70 ttm-bgcolor-grey clearfix">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3><strong>A Miskolc Ablak referencia munkái</strong></h3>
                        <p class="mb-55">Szolgáltatásaink minőségére és az ügyfeleink elégedettségére a legnagyobb hangsúlyt fektetjük. Tekintse meg munkáinkat és vegye igénybe szolgáltatásainkat most.</p>
                    </div>
                </div><!-- row end -->
                <div class="row">
					<?php 
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            <div class="ttm-box-view-content-inner">
                                <!-- featured-thumbnail -->
                                <div class="featured-thumbnail" style="max-height: 380px;">
                                    <a href="#"> <img class="img-fluid" src="<?php echo 'https://ajto-ablak-miskolc.hu/'.$get_images_by_cat['path']?>" alt="<?php echo $get_images_by_cat['title'];?>"></a>
                                </div><!-- featured-thumbnail end-->
                                <!-- ttm-box-view-overlay -->
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" title="<?php echo $get_images_by_cat['title'];?>" data-rel="prettyPhoto" href="<?php echo $server .''.$get_images_by_cat['path']?>"><i class="ti ti-search"></i></a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                            </div>
                            <div class="ttm-box-bottom-content featured-content-portfolio box-shadow2">
                                <span class="category">
                                    <a href="<?php echo $server.'';?>szolgaltatasok/1/miskolc-muanyag-ablak-beepites/">Miskolc műanyag ablak beszerelése</a>
                                </span>
                                <h3 class="featured-title"><a href="<?php echo $server.'';?>szolgaltatasok/1/miskolc-muanyag-ablak-beepites/"><?php echo $get_images_by_cat['title']?></a></h3>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            ...
                            <div class="ttm-box-bottom-content featured-content-portfolio box-shadow2">
                                <span class="category">
                                    <a href="https://www.miskolc-ablak.hu/szolgaltatasok/2/miskolc-bejarati-ajto-beepites">Miskolc bejárati ajtó beépítése</a>
                                </span>
                                <h3 class="featured-title"><a href="https://www.miskolc-ablak.hu/szolgaltatasok/2/miskolc-bejarati-ajto-beepites"><?php echo $get_images_by_cat['title']?></a></h3>
                            </div>
                        </div><!-- featured-imagebox -->
                    </div>
					<?php } ?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            ...
                            <div class="ttm-box-bottom-content featured-content-portfolio box-shadow2">
                                <span class="category">
                                    <a href="https://www.miskolc-ablak.hu/szolgaltatasok/4/miskolc-redony-beepites">Miskolc Redőny készítés és beépítés</a>
                                </span>
                                <h3 class="featured-title"><a href="https://www.miskolc-ablak.hu/szolgaltatasok/4/miskolc-redony-beepites"><?php echo $get_images_by_cat['title']?></a></h3>
                            </div>
                        </div><!-- featured-imagebox -->
                    </div>
					<?php } ?>
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            <div class="ttm-box-view-content-inner">
                                ...
                                <div class="featured-thumbnail">
                                    <a href="#"> <img class="img-fluid" src="image/portfolio/portfolio-1.jpg" alt="image"></a>
                                </div>
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" title="Electrician, New York" data-rel="prettyPhoto" href="https://youtu.be/nKHiP7NH75E"><i class="ti-control-play"></i></a>
                                        <a href="home-maintenance-2.html" class="ttm_link"><i class="ti ti-link"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="ttm-box-bottom-content featured-content-portfolio box-shadow2">
                                ...
                                <h3 class="featured-title"><a href="home-maintenance-2.html">Electrician, New York</a></h3>
                            </div>
                        </div>
                    </div>
                    -->
					...
					<div class="col-lg-12">
						<div class="spacing-5 ttm-bgcolor-white">
							...
							<form id="ttm-quote-form" class="ttm-quote-form wrap-form " method="post" action="#">
								...
								<div class="row">
									<div class="text-input d-flex align-items-center">
										<input class="form-check-input form-check-input-lg me-2" style="height: 2em;width:2em" type="checkbox" name="accept_terms" id="accept_terms" required="required">
										<label class="form-check-label" for="accept_terms" style="font-weight: bold;">
											Megismertem és elfogadom az <a href="#" data-bs-toggle="modal" data-bs-target="#privacyPolicyModal">Adatkezelési Tájékoztatót</a>
										</label>
									</div>
