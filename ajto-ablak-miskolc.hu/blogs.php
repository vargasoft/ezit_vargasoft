...
if(isset($_GET['blog-bejegyzesek']) && isset($_GET['blog-title'])) {
	$blog_id = $_GET['blog-bejegyzesek'];
	$blog_title = $_GET['blog-title'];


	$get_blog_by_id = get_blog_by_id($_GET['blog-bejegyzesek']);
	foreach($get_blog_by_id as $selected_blog) {
		$title = 'Miskolc Ablak | Blog bejegyzés: '.$selected_blog['blog_title'];
		$description = $selected_blog['blog_desc'];
		$image = $selected_blog['blog_images'];
		$datum = $selected_blog['blog_date'];
		$images = $selected_blog['images'];
	}


}else{
	$title = "A Miskolc Ablak - Blog bejegyzéseink";
	$description = "Blog bejegyzéseinkkel szeretnék átláthatóvá tenni szolgáltatásaink minőségét, ugyanakkor azt is szeretnénk ha a hétköznapjainkba minden kedves érdeklődő betekinthetne.";
}
...
<meta name="description" content="<?php echo trim(preg_replace('/\s+/', ' ', strip_tags($description)));?>">
<meta name="author" content="VargaSoft" />

<meta property="og:title" content="<?php echo $title;?>">
<meta property="og:description" content="<?php echo trim(preg_replace('/\s+/', ' ', strip_tags($description)));?>">
<meta property="og:type" content="website">
<meta property="og:url" content="<?php echo $fullUrl;?>">
<?php 
if(isset($_GET['blog-bejegyzesek']) && isset($_GET['blog-title'])) {
?>
<meta property="og:image" content="https://ajto-ablak-miskolc.hu/images/blog/<?php echo $image; ?>">
<?php }else{ ?>
...
<div class="offcanvas offcanvas-bottom" tabindex="-1" id="offer" aria-labelledby="offcanvasBottomLabel" style="min-height: 100%;">
	...
	<div class="page">
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="<?php echo $server.'blog-bejegyzesek/';?>">Blog</a></li>
		...
		<?php if(!isset($_GET['blog-bejegyzesek']) && !isset($_GET['blog-title'])) { ?>
		<div class="site-main">
        		...
        		<div class="container">
        			<div class="row mt_15 mb_15">
        				...
        				<div class="col-lg-4 col-md-6 col-sm-6">
        					<div class="featured-imagebox featured-imagebox-post style-1">
        						<div class="featured-thumbnail ttm-post-thumbnail">
        							<a href="<?php echo $server.'blog-bejegyzesek/'.$blog['id'].'/'.urlencode($blog['blog_title'])?>"><img class="img-fluid" style="max-height: 230px;" src="<?php echo $server.'images/blog/'.$blog['blog_images'];?>" alt="<?php echo $blog['blog_title']?>"></a>
        						</div>
        						<div class="featured-content">
        							<div class="featured-title" style="text-transform: none;">
                                        <h3><a href="<?php echo $server.'blog-bejegyzesek/'.$blog['id'].'/'.urlencode($blog['blog_title'])?>"><?php echo $blog['blog_title']?></a></h3>
                                    </div>
                                    <div class="post-meta pt-10">
                                        <span class="ttm-meta-line post-date">
											...
											<p>
												<?php echo substr($blog['blog_desc'], 0, 50)?>...
											</p>
                                        </span>
                                    </div>
                                    <div class="post-footer">
                                        <div class="post-footer-link">
                                            <a class="ttm-btn btn-inline d-block ttm-btn-size-md ttm-btn-color-skincolor" href="<?php echo $server.'blog-bejegyzesek/'.$blog['id'].'/'.urlencode($blog['blog_title'])?>">Elolvasom a teljes cikket</a>
                                        </div>
                                    </div>
        						</div>
        					</div>
		...
		<?php }else{?>
        	...
        	<div class="sidebar ttm-sidebar-right ttm-bgcolor-white clearfix">
                <div class="container">
                    <div class="row g-0">
                        <div class="col-lg-9">
                           	<div class="ttm-bgcolor-white pt-75 pb-75 pr-30 res-991-pb-0 res-991-pt-0 res-991-mr-0 res-991-pr-0">
                                <div class=" content-area">
    	                           	<article class="post ttm-blog-classic mb-0">
    	                           		<div class="post-featured-wrapper">
    	                           			<div class="post-featured">
    	                                        <img class="img-fluid" src="<?php echo $server;?>images/blog/<?php echo $image;?>" alt="<?php echo $title;?>">
    	                                    </div>
    	                           			<div class="ttm-box-post-date">
    	                           				<span class="ttm-entry-date">
													<?php 
														...
														$month = $date->format('M');
													?>
    	                                            <time class="entry-date" datetime="<?php echo (new DateTime($datum))->format('Y-m-d\TH:i:sP');?>"><?php echo $day; ?><span class="entry-month entry-year"><?php echo $month;?></span></time>
    	                                        </span>
    	                           			</div>
    	                           		</div>
    	                           		<div class="ttm-blog-classic-box-content pb-0">
    	                           			<div class="entry-content">
    	                           				<div class="ttm-entry-meta-wrapper">
    	                           					<div class="ttm-entry-meta">
    	                           						<span class="ttm-meta-line byline">
    	                           							<img class="avatar" src="<?php echo $server;?>images/oszi.png" alt="avatar-image">
    	                           							<span class="author"><a class="url fn n" href="#">Mata Oszkár</a></span>
    	                           						</span>
												...
												<?php 
													if (!empty($images)) {
														// Képek felosztása vesszők mentén
														$imageArray = explode(',', $images);
														
														// HTML struktúra létrehozása
														echo '<div class="row">';
														
														// Minden képhez egy col-sm-6 elem
														foreach ($imageArray as $image) {
															echo '<div class="col-sm-6">';
															echo '<div class="pb-15"><img class="img-fluid" src="'.$server.'images/blog/' . $image . '" alt="'.$title.'"></div>';
															echo '</div>';
														}
														
														echo '</div>'; // Row lezárása
													}
												?>
                        ...
                        <div class="col-lg-3 widget-area sidebar-right ttm-col-bgcolor-yes ttm-bg ttm-right-span ttm-bgcolor-grey res-991-pr-15 res-991-pl-15 res-991-pb-0 res-991-pt-60">
                            <div class="ttm-col-wrapper-bg-layer ttm-bg-layer"></div>
                                <aside class="widget widget-text">
                                 <div class="ttm-author-widget">
                                    <div class="author-widget_img">
                                        <img class="author-img" src="<?php echo $server;?>images/oszi.png" style="height: 200px;width:200px" alt="Mata Oszkár">
                                    </div>
                                    <h4 class="author-name text-center">Mata Oszkár</h4>
                                    <p class="author-widget_text">
                                        Remélem, hogy blog bejegyzésünkkel hasznos információkhoz sikerült jutnia szolgáltatásunkkal kapcsolatban.
										Amennyiben kérdése vagy észrevétele van, keressen elérhetőségeinken.
                                    </p>
                                    
                                 </div>
                                
                                <aside class="widget widget-recent-post">
                                <h3 class="widget-title">További blog bejegyzések</h3>
                                ...
                                <aside class="widget tagcloud-widget">
                                    <h3 class="widget-title">Kulcssző felhő</h3>
                                    <div class="tagcloud" style="font-size: 11px;">
										<a href="#" class="tag-cloud-link">Műanyag ablak beépítés Miskolc</a>
										<a href="#" class="tag-cloud-link">Ablak beszerelés Miskolc</a>
										<a href="#" class="tag-cloud-link">Nyílászárók beépítése</a>
										<a href="#" class="tag-cloud-link">Bejárati ajtó beépítés</a>
										<a href="#" class="tag-cloud-link">Beltéri ajtó</a>
										<a href="#" class="tag-cloud-link">Ajtócsere Miskolc</a>
										<a href="#" class="tag-cloud-link">Redőny beépítése Miskolc</a>
										<a href="#" class="tag-cloud-link">Redőny beszerelés</a>
										<a href="#" class="tag-cloud-link">Napellenző készítés</a>
										<a href="#" class="tag-cloud-link">Szúnyogháló beépítése</a>
										<a href="#" class="tag-cloud-link">Insect screen</a>
										<a href="#" class="tag-cloud-link">Ajtórendszer</a>
										<a href="#" class="tag-cloud-link">Szélvédő ajtó</a>
										<a href="#" class="tag-cloud-link">Ajtószárny</a>
										<a href="#" class="tag-cloud-link">Ajtótok</a>
										<a href="#" class="tag-cloud-link">Szárnyas ablak</a>
										<a href="#" class="tag-cloud-link">Vízálló ablak</a>
										<a href="#" class="tag-cloud-link">Pánikzár</a>
										<a href="#" class="tag-cloud-link">Beltéri ajtó beépítés</a>
										<a href="#" class="tag-cloud-link">Napellenző készítés</a>
										<a href="#" class="tag-cloud-link">Árnyékoló rendszer</a>
										<a href="#" class="tag-cloud-link">Roló beépítés</a>
										<a href="#" class="tag-cloud-link">Biztonsági redőny</a>
										<a href="#" class="tag-cloud-link">Szúnyogháló beszerelése Miskolc</a>
										<a href="#" class="tag-cloud-link">Védőrács</a>
										<a href="#" class="tag-cloud-link">Betonkerítés</a>
										<a href="#" class="tag-cloud-link">PVC ajtó beépítés</a>
										<a href="#" class="tag-cloud-link">Ablak beépítése ház</a>
										<a href="#" class="tag-cloud-link">Redőny javítás</a>
										<a href="#" class="tag-cloud-link">Rehua műanyag ablak</a>
									</div>
