...
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>Wer und Wo? Wi finde ich?</title>
    ...
    <body>
        ...
        <div id="main">
            ...
            <header class="main-header">
                ...
                <div class="show-reg-form modal-open avatar-img" data-srcav="images/avatar/3.jpg"><i class="fal fa-user"></i>Anmelden</div>
                <!-- header opt end--> 
                <!-- lang-wrap-->
                <div class="lang-wrap">
                    <div class="show-lang"><span><i class="fal fa-globe-europe"></i><strong>DE</strong></span><i class="fa fa-caret-down arrlan"></i></div>
                    <ul class="lang-tooltip lang-action no-list-style">
                        <li><a href="#" class="current-lan" data-lantext="De">Deutsch</a></li>
                ...
                <div class="header-search_container header-search vis-search">
                    <div class="container small-container">
                        <div class="header-search-input-wrap fl-wrap">
                            ...
                            <!-- header-search-input end --> 
                            <button class="header-search-button green-bg" onclick="window.location.href='listing.html'"><i class="far fa-search"></i> Suchen </button>
                        </div>
...
<!-- Mirrored from townhub.kwst.net/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jun 2024 09:09:49 GMT -->
</html>