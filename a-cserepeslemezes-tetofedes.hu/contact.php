...
$alt = 'Cserepeslemezes tetőfedés | Cserepeslemezes tetőfelújítás | Lemeztető készítés';
$title = "Kapcsolat | Cserepeslemezes tetőfedés";
...
<html class="no-js" lang="hu">
    ...
    <body>
        ...
        <main class="main-area fix">
			<div class="breadcrumb__area breadcrumb__bg" data-background="<?php echo $server;?>images/contact.png">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb__content">
								...
								<nav class="breadcrumb">
									...
									<span property="itemListElement" typeof="ListItem">Kapcsolat</span>
								</nav>
							</div>
						</div>
					</div>
					...
					<div class="row gutter-24">
							...
							<div class="contact__info-wrap">
								...
								<div class="contact__info-item">
									<div class="contact__info-content">
										...
										<div class="content">
											<span>Email címünk</span>
											<h2 class="title"><a href="mailto:<?php echo $email;?>"><?php echo $email;?></a></h2>
										</div>
									</div>
								</div>
								<div class="contact__info-item">
									<div class="contact__info-content">
										...
										<div class="content">
											...
											<h2 class="title"><a href="tel:<?php echo $telefon;?>"><?php echo $telefon;?></a></h2>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-8">
							...
							<div class="contact-map">
								<iframe src="https://www.google.com/maps/d/embed?mid=1p_2jZHDEqZGdAo3Lag3s5TG4ED7WP3s" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							...
							<div class="col-lg-12">
								<div class="contact__form-wrap">
									<div class="section__title section__title-three mb-40">
										<span class="sub-title">Lépjen velünk kapcsolatba</span>
										<h2 class="title">Kérdése vagy észrevétele van?</h2>
										<br />
										<span class="sub-title">Adja meg a szükséges adatokat és küldjön üzenetet nekünk.</span>
									</div>
									
								</div>
							
								<form id="contact" action="#" method="post" class="contact__form">
									<div class="row gutter-20">
										<div class="col-md-4">
											<div class="form-grp">
												<input type="text" name="name" id="name" placeholder="Neve" required>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-grp">
										...
										<div class="col-md-4">
											<div class="form-grp">
												<input type="email" name="email" id="email" placeholder="Email címe" required>
											</div>
										</div>
									</div>
									<div class="form-grp">
										<input type="text" name="service" id="service" placeholder="Mivel kapcsolatban keres bennünket? (Tárgy)" required>
									</div>
									<div class="form-grp">
										<textarea name="message" id="message" placeholder="Ide írhatja üzenetét" required></textarea>
									</div>
									<button type="submit" id="offer" name="offer" class="btn btn-two">Üzenet elküldése</button>
								</form>
							</div>
						</div>
					</div>
