...
if (EMPTY($_GET['blog-bejegyzesek'])){
	$alt = 'Cserepeslemezes tetőfedés, Tetőfedés cserepes lemezzel, Lemeztető készítés';
	$title = "Blog bejegyzések - Cserepeslemezes tetőfedés";
	...
	foreach($get_blog_by_id as $blog) {
		$blog_id = $blog['id'];
		...
		$title = 'Blog bejegyzés: '.$blog['blog_title'];
		$description = 'Tekintse meg hetente frissülő blog bejegyzéseinket. "Minőségi cserepeslemez tetőfedés és tető felújítás cserepeslemezzel. Lemeztető készítés és lemeztető felrakása. Tapasztalt csapatunk gondoskodik a professzionális szerelésről.';
		$keywords = 'cellulóz fújható szigetelés, purhab szigetelés, hőszigetelés, szigetelés szolgáltatás, otthoni szigetelés';
		$alt = $title;
...
<html class="no-js" lang="hu">
    <head>
		...
		<meta property="og:type" content="website">
		<meta property="og:url" content="<?php echo $fullUrl;?>">
		<meta property="og:image" content="<?php echo $server;?>images/blog/<?php echo $blog_images;?>">
		<meta property="og:site_name" content="VargaSoft">
		<meta property="og:locale" content="hu_HU">
		<meta property="og:keywords" content="<?php echo $description;?>">
		<meta property="fb:app_id" content="100093287431136">
    ...
    <body>
        ...
        <main class="main-area fix">
			...
			<?
				if (EMPTY($_GET['blog-bejegyzesek'])){
			?>
			<div class="breadcrumb__area breadcrumb__bg" data-background="<?php echo $server?>images/blog_bg.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb__content">
								<h1 class="title" style="color:#fff"><?php echo $title;?></h1>
								<nav class="breadcrumb"  style="color:#fff">
									<span property="itemListElement" typeof="ListItem">
										<a href="<?php echo $server;?>"  style="color:#fff">Kezdőoldal</a>
									</span>
									<span class="breadcrumb-separator">/</span>
									<span property="itemListElement" typeof="ListItem" style="color:#fff">Blog bejegyzések</span>
								</nav>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="blog__post-item shine__animate-item">
								...
								<div class="blog__post-content">
									...
									<a href="<?php echo $server.'blog-bejegyzesek/'.$blog['id'].'/'.urlencode($blog['blog_title'])?>" class="btn">Elolvasom a cikket</a>
								</div>
							</div>
						</div>
					<?php 
					...
					<div class="row">
						<div class="col-lg-8">
							<div class="blog__details-thumb">
								<img src="<?php echo $server;?>images/blog/<?php echo $blog_images;?>" alt="<?php echo $blog_title;?>">
							</div>
							<div class="blog__details-content">
								<div class="blog__post-meta">
									<ul class="list-wrap">
										<li>Szerző <a href="<?php echo $server.'blog-bejegyzesek/'.$blog_id.'/'.urlencode($blog_title);?>">Varga Ferenc</a></li>
										<li><?php $datum = strtotime($blog_date); echo date('Y. ', $datum) . $honapok[date('F', $datum)] . date(' j.', $datum); ?></li>
										<li class="tach"><a href="<?php echo $server.'blog-bejegyzesek/'.$blog_id.'/'.urlencode($blog_title);?>">Cserepeslemezes Tetőfedés</a></li>
									</ul>
								</div>
						...
						<div class="col-lg-4">
							<aside class="blog__sidebar">
								...
								<div class="blog__widget">
									<h4 class="blog__widget-title">Szolgáltatások</h4>
									<div class="blog__cat-list">
										<ul class="list-wrap">
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/cserepeslemezes-tetofedes/">Cserepeslemezes tetőfedés
													<span><i class="renova-right-arrow"></i> <strong>01</strong></span>
												</a>
											</li>
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/tetofelujitas-cserepeslemezzel/">Tetőfelújítás cserepeslemezzel
													<span><i class="renova-right-arrow"></i> <strong>02</strong></span>
												</a>
											</li>
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/lemezteto-keszites/">Lemeztető készítés
													<span><i class="renova-right-arrow"></i> <strong>03</strong></span>
												</a>
											</li>
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/lemezteto-felrakasa/">Lemeztető felrakása
													<span><i class="renova-right-arrow"></i> <strong>04</strong></span>
												</a>
											</li>
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/korcolt-lemezes-tetofedes/">Korcolt lemezes tetőfedés
													<span><i class="renova-right-arrow"></i> <strong>05</strong></span>
												</a>
											</li>
											<li>
												<a href="<?php echo $server;?>szolgaltatasok/trapezlemezes-tetofedes/">Trapézlemezes tetőfedés
													<span><i class="renova-right-arrow"></i> <strong>06</strong></span>
												</a>
											</li>
										</ul>
									</div>
								...
								<div class="blog__widget">
									<h4 class="blog__widget-title">Blog bejegyzések</h4>
									...
									?>
										<div class="blog__rc-post-item">
											...
											<div class="content">
												<span class="date"><i class="renova-clock"></i><?php $datum = strtotime($blog['blog_date']); echo date('Y. ', $datum) . $honapok[date('F', $datum)] . date(' j.', $datum); ?></span>
												<h2 class="title"><a href="<?php echo $server.'blog-bejegyzesek/'.$blog['id'].'/'.urlencode($blog['blog_title'])?>"><?php echo $blog['blog_title'];?></a></h2>
											</div>
										</div>
									<?php } ?>
									</div>
                        ...
                        <div class="col-lg-6" id="cserep_elony">
                            <div class="about__content">
                                <div class="section__title mb-20">
                                    <h2 class="title" style="font-size: 48px;">Cserepeslemezes tetőfedés</h2>
