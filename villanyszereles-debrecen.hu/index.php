                                                                ...
                                                                <div class="layout01__content">
                                                                    <div class="layout01__content-wrapper">
                                                                        <div class="section-title text-left">
                                                                            <div class="section-title__01"><?php echo $company.', <h1 style="font-size: 16px; line-height: 26px; color: #f47629; font-weight: 600; font-family: "Poppins",sans-serif;">'.$site_h1;?></h1></div>
                                                            ...
                                                            <div class="tt-box02_wrapper row slick-type01 slick-slider slick-dotted" data-slick='{ "slidesToShow": 3, "autoplaySpeed": 4500, "slidesToScroll": 2, "responsive": [ { "breakpoint": 750, "settings": { "slidesToShow": 2 } }, { "breakpoint": 546, "settings": { "slidesToShow": 1, "slidesToScroll": 1 } } ] }' >
																...
																<div class="col-md-4">
                                                                    <div class="tt-box02">
                                                                        ...
                                                                        <h2 class="tt-box02__title" style="font-size:20px"><a href="<?php echo $server;?>szolgaltatasok/"><?php echo $get_all_services['title'];?></a></h2>
								 ...
								 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="wpcf7-form init">
                                    ...
                                    <div class="form-group">
                                        <span class="wpcf7-form-control-wrap date">
											<input type="text" name="date" id="date" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" aria-required="true" placeholder="Kivitelezés kívánt dátuma, pl. <?php $plus_date = date("Y-m-d", strtotime("+ 14 day")); echo $plus_date;?>" />
										</span>
										<script type="text/javascript">
												$(function() {  
													$("#date").datepicker({
