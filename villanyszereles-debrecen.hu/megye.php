...
//Telepules
$get_telepules_info_from_telepules_nev = get_telepules_info_from_telepules_nev($_GET['villanyszereles']);
foreach($get_telepules_info_from_telepules_nev as $get_telepules_info_from_telepules_nev) {
		
		
		
		$telepules = $get_telepules_info_from_telepules_nev['name'];
		$telepules_ex = $get_telepules_info_from_telepules_nev['varos_ex'];
		$megye = $get_telepules_info_from_telepules_nev['megye'];
		$megye_ex = $get_telepules_info_from_telepules_nev['megye_ex'];
		$telepules_id = $get_telepules_info_from_telepules_nev['id'];
		
		$site =  $get_telepules_info_from_telepules_nev['name'];
...
$get_domain_detail_infos = get_domain_detail_infos($_SERVER['SERVER_NAME'], 'megye.php');
foreach($get_domain_detail_infos as $get_domain_detail_infos) {

	
	$oldal_title = str_replace('$', $site, $get_domain_detail_infos['site_title']);
	$site_description = str_replace('$', $site, $get_domain_detail_infos['site_description']);
	$site_keywords = str_replace('$', $site, $get_domain_detail_infos['site_keywords']);
	$site_h1 = str_replace('$', $site, $get_domain_detail_infos['site_h1']);
...
//oldal
$site_name = 'Település / Megye: '.$telepules;
...
<script>
  ...
  gtag('config', 'G-14EFZJ16GY');
        ...
        <link rel="canonical" href="https://villanyszereles-debrecen.hu/villanszereles/<?php echo $_GET['villanyszereles'];?>" />
		...
		"item":
		{
		"@id": "https://villanyszereles-debrecen.hu/rapid-szolgaltatas/",
	...
	<script>
	  ...
	  ga('send', 'pageview');
        ...
        <header id="tt-header">
            ...
            <div id="js-init-sticky" style="max-height: 50px;">
                            ...
                            <div class="tt-col-objects tt-col-wide text-center">
                                <nav id="tt-nav">
                                    <ul id="menu-primary-menu" class="nav navbar-nav">
                                        <li id="nav-menu-item-1459" class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-1426 current_page_item">
        ...
        <div data-elementor-type="wp-page" data-elementor-id="1426" class="elementor elementor-1426" data-elementor-settings="[]">
            <div class="elementor-inner">
                <div class="elementor-section-wrap">
                     ...
                     <section class="elementor-section elementor-top-section elementor-element elementor-element-acee1d5 elementor-section-full_width elementor-section-stretched elementor-section-height-default elementor-section-height-default" data-id="acee1d5" data-element_type="section" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
                                        ...
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-37c4f70 elementor-widget elementor-widget-elec_work_category" data-id="37c4f70" data-element_type="widget" data-widget_type="elec_work_category.default">
                                                <div class="elementor-widget-container">
                                                    <div class="section-indent overflow-hidden" style="margin-top:0px;">
                                                        <div class="tt-slideinfo-wrapper slick-type01">
															 <div class="tt-slideinfo">
                                                                <div class="tt-item__bg">
                                                                    <div data-bg="<?php echo $server;?>img/lakas.jpg" class="lazyload tt-item__bg-img" alt="Lakások, családi házak villanyszerelése"></div>
                                                                    <div class="tt-item__bg-top"></div>
                                                                </div>
                                                                <div class="tt-item__content">
                                                                    <div class="tt-item__title"><span class="tt-icon"><img src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" class="lazyload" data-src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" alt="Lakások, családi házak <br />villanyszerelése"></span>
																		<span class="tt-text">Lakások, családi házak <br />villanyszerelése</span>
																	</div>
                                                            ...
                                                            <div class="tt-slideinfo">
                                                                <div class="tt-item__bg">
                                                                    <div data-bg="<?php echo $server;?>img/kereskedelmi.jpg" class="lazyload tt-item__bg-img" alt="Kereskedelmi létesítmények villanyszerelése"></div>
                                                                    <div class="tt-item__bg-top"></div>
                                                                </div>
                                                                <div class="tt-item__content">
                                                                    <div class="tt-item__title"><span class="tt-icon"><img src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" class="lazyload" data-src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" alt="Kereskedelmi létesítmények villanyszerelése"></span>
																	<span class="tt-text">Kereskedelmi létesítmények<br />villanyszerelése</span></div>
                                                                    
                                                                </div>
                                                            </div>
                                                            <div class="tt-slideinfo">
                                                                <div class="tt-item__bg">
                                                                    <div data-bg="<?php echo $server;?>img/ipari.jpg" class="lazyload tt-item__bg-img" alt="Ipari létesítmények, telephelyek villanyszerelése"></div>
                                                                    <div class="tt-item__bg-top"></div>
                                                                </div>
                                                                <div class="tt-item__content">
                                                                    <div class="tt-item__title"><span class="tt-icon"><img src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" class="lazyload" data-src="<?php echo $server;?>wp-content/plugins/electricity-core/assets/images/slideinfo-marker.png" alt="Ipari létesítmények, telephelyek villanyszerelése"></span>
																		<span class="tt-text">Ipari létesítmények, telephelyek<br /> villanyszerelése</span></div>
                                                        ...
                                                        <div class="container container-lg-fluid">
                                                            <div class="layout01 layout01__img-more">
                                                                <div class="layout01__img">
                                                                    <div class="tt-img-main"> <img width="672" height="552" src="<?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img01.jpg" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img01.jpg 672w, <?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img01-300x246.jpg 300w, <?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img01-598x491.jpg 598w, <?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img01-600x493.jpg 600w" sizes="(max-width: 672px) 100vw, 672px" /></div>
                                                                    <div class="tt-img-more left-bottom"> <img width="436" height="290" src="https://villanyszereles-debrecen.hu/wp-content/uploads/sites/6/2020/07/layout01-img02.jpg" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img02.jpg 436w, <?php echo $server;?>wp-content/uploads/sites/6/2020/07/layout01-img02-300x200.jpg 300w" sizes="(max-width: 436px) 100vw, 436px" /></div>
                                                                </div>
                                                                <div class="layout01__content">
                                                                    <div class="layout01__content-wrapper">
                                                                        <div class="section-title text-left">
                                                                            <div class="section-title__01"><?php echo '<h1 style="font-size: 16px; line-height: 26px; color: #f47629; font-weight: 600; font-family: "Poppins",sans-serif;">'.$site_h1.', '.$company?></h1></div>
                                                                            <div class="section-title__02">Minden, ami villanyszerelés</div>
                                                                        </div>
                                                                        <p> Szolgáltatásaink minőségét 100%-os elégedettségi garancia garantálja. Legyen szó ipari, kereskedelmi vagy lakossági igényekről, cégünk a <?php echo $company;?> megbízható, gyors és professzionális kivitelezéssel garantálja, hogy Ön is elégedett legyen.</p>
                                                                        <ul class="tt-list01 tt-list-top">
                                                                            <li>Teljes körű szolgáltatás</li>
                                                                            <li>Huzalozás, kábelezés és telepítés</li>
                                                                            <li>Vészhelyzeti áramellátási megoldások (generátorok)</li>
                                                                            <li>Bármilyen igénye legyen, állunk rendelkezésére</li>
                                                                        </ul>
                                                                            ...
                                                                            <div class="tt-item">
                                                                                <div class="personal-box">
                                                                                    ...
                                                                                    <div class="personal-box__content">
                                                                                        <div class="personal-box__title"> <?php echo $owner;?></div>
                                                                                        <?php echo $company.' - Villanyszerelés Debrecenben és környékén';?>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="section-indent">
                                                        <div class="container container-lg-fluid container__p-r">
                                                            ...
                                                            <div class="section-title max-width-01 section-title_indent-02">
                                                                ...
                                                                <div class="section-title__02"><?php echo $company;?> - Teljeskörű villanyszerelési szolgáltatások <?php echo $_GET['villanyszereles'].' településen is';?></div>
                                                            </div>
                                                            ...
                                                            <div class="container">
                                                                <div class="tt-box01__holder">
                                                                    <div class="tt-box01__description">
                                                                        <h4 class="tt-box01__title"> Vegye igénybe <span class="tt-base-color">villanyszerelési </span><br> szolgáltatásainkat <?php echo $_GET['villanyszereles'].' településen is';?>!</h4>
                                                                        <p>
                                                    ...
                                                    <div class="section-indent">
                                                        <div class="container container-md-fluid">
                                                            <div class="section-title max-width-01">
                                                                <div class="section-title__01">@<?php echo $company.', '.$site_h1;?></div>
                                                                <div class="section-title__02">Referencia munkáink</div>
                                                            </div>
															<div id="filter-nav">
																<ul>
					...
					<div class="section-indent">
						<div class="container container-lg-fluid">
							<div class="section-title max-width-01">
								<div class="section-title__01">Villanyszerelés <?php echo $_GET['villanyszereles'].' településen is';?>, HutiVill</div>
        ...
        <div class="modal fade" id="modalMakeAppointment" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
		 ...
		 <script type='text/javascript' id='elementor-frontend-js-before'>var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false},"i18n":{"shareOnFacebook":"Weboldal megosztása Facebookon","shareOnTwitter":"Weboldal megosztása Twitteren","pinIt":"Pin it","download":"Download","downloadImage":"Kép letöltése","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"version":"3.0.15","is_static":false,"legacyMode":{"elementWrappers":true},"urls":{"assets":"https:\/\/villanyszereles-debrecen.hu\/electrician-v2\/demo3\/wp-content\/plugins\/elementor\/assets\/"},"settings":{"page":[],"editorPreferences":[]},"kit":{"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":1426,"title":"Home%20-%20Electrician%20Demo%2003","excerpt":"","featuredImage":false}};</script> 
