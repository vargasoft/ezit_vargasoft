...
<script>
  ...
  gtag('config', 'G-14EFZJ16GY');
        ...
        <link rel="canonical" href="https://villanyszereles-debrecen.hu/kapcsolat/" />
	  ...
	  ga('send', 'pageview');
        ...
        <header id="tt-header">
			...
			if (isset($_POST["ajanlatkeres"]) && !empty($_POST["email"])) {
				...
				echo"<div class='alert alert-success'>Kedves ".$_POST["name"]."! Köszönjük, hogy igénybe vette ingyenes online árajánlatkérőnket. Kollégáink a kérését megvizsgálják és elérhetőségei egyikén felveszik Önnel a kapcsolatot.</div>";
			...
			if (isset($_POST["fullnames"]) && !empty($_POST["email"])) {
				...
				echo"<div class='alert alert-success'>Kedves ".$_POST["fullnames"]."! Köszönjük, hogy kérdésével megtisztelt bennünket. Kollégáink a kérését megvizsgálják és elérhetőségei egyikén felveszik Önnel a kapcsolatot.</div>";
                            ...
                            <div class="tt-col-objects tt-col-wide text-center">
                                <nav id="tt-nav">
                                    <ul id="menu-primary-menu" class="nav navbar-nav">
                                        ...
                                        <li id="nav-menu-item-123" class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1426 current_page_item">
        ...
        <div data-elementor-type="wp-page" data-elementor-id="1426" class="elementor elementor-1426" data-elementor-settings="[]">
			...
			<div class="elementor-element elementor-element-f6a15fe elementor-widget elementor-widget-electrician_contact_form" data-id="f6a15fe" data-element_type="widget" data-widget_type="electrician_contact_form.default">
				...
				<div class="elementor-widget-container">
					<div class="section-indent" style="margin-top: 10px;">
						<div class="container container-md-fluid">
							...
							<div class="row justify-content-center">
								<p>Kérdése, észrevétele van? Ne habozzon. Adja meg adatait, tegye fel kérdését és <br />kollégáink a lehető leghamarabb válaszolnak megkeresésére!<br /><br /></p>
								<div class="col-md-8">
									<div role="form" class="wpcf7" id="wpcf7-f2256-p14-o1" lang="en-US" dir="ltr">
										<div class="screen-reader-response">
											<p role="status" aria-live="polite" aria-atomic="true"></p>
											<ul></ul>
										</div>
										<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="kapcsolat" id="kapcsolat" class="wpcf7-form">
											
											<div class="form-default">
												<div class="form-group">
													<span class="wpcf7-form-control-wrap your-name">
														<input type="text" name="fullnames" id="fullnames" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" placeholder="Adja meg teljes nevét!" required>
													</span>
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<span class="wpcf7-form-control-wrap your-email">
																<input type="email" name="email" id="email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-control" aria-required="true" aria-invalid="false" placeholder="Adja meg email címét!" required>
															</span>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<span class="wpcf7-form-control-wrap your-phone">
																<input type="text" name="phone" id="phone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" placeholder="Adja meg telefonszámát!" required>
															</span>
														</div>
													</div>
												</div>
												<div class="form-group">
													<span class="wpcf7-form-control-wrap your-message">
														<textarea name="message" id="message" cols="40" rows="4" class="wpcf7-form-control wpcf7-textarea form-control" aria-invalid="false" placeholder="Üzenetét, kérdését, észrevételét ide írhatja." required></textarea>
													</span>
												</div>
												<div class="justify-content-center">
													<button class="tt-btn btn__color02 wpcf7-form-control wpcf7-submit justify-content-left" type="submit" style="padding: 9px 100px 10px;">
														<span class="icon-482948"></span> Üzenet elküldése
													</button>
							...
							<div class="row justify-content-center">
								<div class="col-sm-6 col-md-4">
									<div class="tt-contact">
										<div class="tt-icon"> <i aria-hidden="true" class=" icon-map-marker"></i></div>
										<div class="tt-content">
											<div class="tt-title">Cím:</div>
											<address> <?php echo $owner.', '.$company;?><br> <?php echo $company_address;?> </address>
										</div>
									</div>
								</div>
								<div class="col-sm-6 col-md-4">
									<div class="tt-contact">
										<div class="tt-icon"> <i aria-hidden="true" class=" icon-clock-circular-outline-1"></i></div>
										<div class="tt-content">
											<div class="tt-title">Nyitvatartás:</div>
											Hétfő - Szombat 07:00 - 17:00<br>Rapid Szolgáltatás: 7/24
										</div>
									</div>
								</div>
								<div class="col-sm-6 col-md-4">
									<div class="tt-contact">
										<div class="tt-icon"> <i aria-hidden="true" class=" icon-telephone"></i></div>
										<div class="tt-content">
											<div class="tt-title">Telefonszám, email cím:</div>
											<address> <a href="tel:<?php echo $telefon;?>"><?php echo $telefon;?></a> </address>
											<address> <a href="mailto:<?php echo $email;?>"><?php echo $email;?></a> </address>
										</div>
									</div>
								</div>
							</div>
		...
		<div style="display:none">
				<?php
					...
					foreach($get_all_city as $get_all_city) {
						echo '<a href="https://villanyszereles-debrecen.hu/villanyszereles-'.replace_spec_chars(strtolower($get_all_city['name'])).'"><h2>Villanyszerelés '.$get_all_city['name'].'</a></h2>, ';
						echo '<a href="https://villanyszereles-debrecen.hu/villanyszereles-'.replace_spec_chars(strtolower($get_all_city['name'])).'"><h2>Villanyszerelés '.$get_all_city['name'].'</a></h2>, ';
					}
